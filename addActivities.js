...
activities.forEach(activity => {
    ...
    title.innerText = `${activity.sport_type}: ${activity["start_date_local"].slice(0,10)}`


    const titleDiv = Object.assign(document.createElement("div"), { className: "title" });
    const mapDiv = Object.assign(document.createElement("div"), { className: "map" });
